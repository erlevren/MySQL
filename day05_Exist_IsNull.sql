...
select * from kisiler order by adres asc; -- asc default olarak artan yapiyor
select * from kisiler order by adres desc; -- desc azalana gore siralar
...
select * from kisiler where isim = 'Mahmut' order by maas;
